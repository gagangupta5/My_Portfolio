...
export default function About() {
  const stats = [
    {label: "Experience", value: "Project Based"},
    {label: "Speciality", value: "MERN Stack"},
    {label: "Focus", value: "Performance & Problem Solving"}
  ]
  const glows = [
    ...
    className="min-h-screen w-full flex items-center justify-center relative bg-black text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          ...
          rounded-2xl overflow-hidden shadow-2xl bg-linear-to-br from-[#1cd8d2]/20 to-[#302b63]/20
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I’m an aspiring Web & MERN Stack Developer, currently learning and building projects to strengthen my skills.
              I’m passionate about creating fast, user-friendly applications and continuously improving my development knowledge.
            </p>
        ...
        >
              ...
              <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
                I’m a MERN Stack enthusiast learning MongoDB, Express.js, React, and Node.js while building hands-on projects.
              </p>
              <p className="mt-4 text-gray-400 text-base sm:text-lg">
                I’m focused on growing my skills and creating scalable web applications.
              </p>
        </motion.div>
      </div>
    </section>

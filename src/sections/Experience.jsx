...
const experiences = [
  {
    ...
    duration : "26 May 2025 - 28 June 2025",
    description : "Completed hands-on learning across multiple Cybsersecurity tasks and domains"
  }
];
  ...
  return(
    <div className="relative flex items-start">
      ...
      >
        ...
        <p className="text-sm text-gray-400 wrap-break-words">

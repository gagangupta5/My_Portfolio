...
const socials = [
  {Icon : FaLinkedin, label:"LinkedIn", href: "https://www.linkedin.com/in/gagan-gupta-968200317"},
  {Icon : FaGithub, label: "GitHub", href: "https://github.com/gagangupta5"}
]
  ...
  return (
    ...
    id="home" className="w-full h-screen relative bg-black overflow-hidden">
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        <div className="flex flex-col justify-center h-full text-center lg:text-left relative">
          <div className="w-full lg:pr-24 mx-auto max-w-3xl">
            ...
            >
              Developing modern, user-focused applications with a strong foundation in performance and scalability.
            </motion.p>
      ...
      <div className="relative hidden lg:block">
        ...
        />
        <motion.img src={avator} alt="Gagan Gupta" 
